...
use App\Models\ControlPanelsMaster; // A Code: 29-06-2026
use DB;
    ...
    {        
        ...
        foreach ($electricalLists as $electricalList) {
            if (($electricalList->code >= 1 && $electricalList->code <= 13 && $rangeAndCode['starter_code'] != 'Xtreme' ) 
                ...
                || (($electricalList->code == 46 || $electricalList->code == 48 
                || $electricalList->code == 50) && $rangeAndCode['starter_code'] != 'Xtreme' && $rangeAndCode['voltage_id'] != 1 ) 
                || ($electricalList->code == 51 && $rangeAndCode['starter_code'] != 'Xtreme' )) {
                $electricalListsData[] = $electricalList;
            }
            if (($electricalList->code == 45 || $electricalList->code == 47 || $electricalList->code == 49) 
                && $rangeAndCode['voltage_id'] == 1 && $rangeAndCode['stater_type_id'] == 2) { //voltage_id = 230 V, Only starter constant speed Dol
                $electricalListsData[] = $electricalList;
            }

            if (($electricalList->code >= 14 && $electricalList->code <= 15 && $rangeAndCode['range'] == 3) 
                || ($electricalList->code == 29 && $rangeAndCode['range'] == 3) 
                || ($electricalList->code >= 41 && $electricalList->code <= 43 && $rangeAndCode['range'] == 3) 
                || ($electricalList->code == 52 && $rangeAndCode['range'] == 3)) { // 3 = Premium
                $electricalListsData[] = $electricalList;
            }
            ...
            // || ($electricalList->code >= 30 && $electricalList->code <= 36 && $rangeAndCode['starter_code'] != 'Xtreme')) {
            if (($electricalList->code >= 27 && $electricalList->code <= 28 && $rangeAndCode['starter_code'] != 'Xtreme') 
        ...
        $data = view('frontend.booster.electrical_optional')
                ->with('electricalListsData', $electricalListsData)
                ->render();
