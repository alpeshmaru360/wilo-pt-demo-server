                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    @if (auth()->user()->isAdmin() && $stock_check)
                                        <th width="25%">Replaced Description</th>
                                    @endif
                                    ...
                                    <!-- A Code: 11-04-2026 Start -->
                                    @if (auth()->user()->isAdmin() && $stock_check)
                                        <th width="8%">Replaced Article No.</th>
                                    @endif
                                    <!-- A Code: 11-04-2026 End -->
                            ...
                            <tbody>
                                @foreach($items as $key=> $item)
                                    ...
                                    <tr>
                                        ...
                                        <!-- A Code: 11-04-2026 Start -->
                                        @if ($stock_check)
                                        <td>{{$item->replaced_description}}</td>
                                        @endif  
                                        <td>{{$item->wilo_artilce_no}}</td>
                                        @if ($stock_check)
                                        <td>{{$item->replaced_article_number}}</td>
                                        @endif  
                                        <!-- A Code: 11-04-2026 End -->                                    

                                        @if(auth()->user()->isAdmin())
                                            <td>{{$item->adder_code}}</td>
