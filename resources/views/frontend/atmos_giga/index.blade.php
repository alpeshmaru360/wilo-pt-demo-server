...
<style>
    ...
    #pump_model_required_size::placeholder{font-size: 15px !important;}
</style>
...
<script>
    ...
    $("#power_supply").on('change', function (e) {
        let power_supply = $(this).val();

        $("#frequency").removeAttr('disabled');

        if (power_supply == 400) {
            $("#frequency option[value='60']").attr('disabled', 'disabled');
            $("#frequency option[value='50']").removeAttr('disabled');
        } else {
            $("#frequency option[value='50']").attr('disabled', 'disabled');
            $("#frequency option[value='60']").removeAttr('disabled');
        }
    ...
    //         $("#bareshaft_pump_article_number_section").css('display','none');
    //         $("#pump_model_manual_add").css('display','block');
    //         $("#pump_model, #impeller_material").attr('disabled', 'disabled');x
    //     }
    //     else{
    //         $("#full_article_number_section").css('display','block');
    //         $("#bareshaft_pump_article_number_section").css('display','none');
