...
<script>
        ...
        if ($('#main_panel_selection').val() == 'electrical-diesel') {
            if ($(this).val() != '') {
                ...
                var disableDieselSelection = {
                    'diesel_pumptype':'pump_type', 'diesel_frequency':'frequency', 'diesel_pump_approval':'pump_approval', 'diesel_engine_approval':'engine_approval', 'diesel_flow':'flow', 'diesel_head':'head', 'diesel_speed':'speed_rpm'
                };
                var db_original_key = '';
    ...
    function disableElectricalInput(changed = '') {
        var disableElectricalList = ['electrical_pumptype', 'electrical_frequency', 'electrical_pump_approval', 'electrical_flow', 'electrical_head', 'electrical_speed'];

        var disableDieselList = ['diesel_pumptype', 'diesel_frequency', 'diesel_pump_approval', 'diesel_engine_approval', 'diesel_flow', 'diesel_head', 'diesel_speed'];
        ...
        if (changed == '') {
            ...
            if (electricalSelectedData != '') {
                ...
                if (main_panel_selection == 'electrical-diesel') {
                    ...
                    electrical_with_diesel_change.push('<option value="">'+ disableElectricalSelectionOptionsText[changed] +'</option>');
...
<script>
        ...
        if (optional_check) {
            ...
            if (pump_type == 'electrical' || pump_type == 'electrical-diesel') {
                ...
                if (pump_type == 'electrical-diesel') {
                    modal_heading = `<h6 data-type="electrical" class="modal-heading-change active">Electrical</h6>`;
                    var electrical_diesel_modal_heading = `<div class="main-table"><h6 data-type="diesel" class="modal-heading-change">Diesel</h6></div>`;
                } else {
    ...
    function electricalDieselPumpPriceCalculate() {
        ...
        if (checkvalblank) {
            ...
            var dieselSelection = {
                'diesel_pumpmodels':'pump_models', 'diesel_pumptype':'pump_type', 'diesel_frequency':'frequency', 'diesel_pump_approval':'pump_approval', 'diesel_engine_approval':'engine_approval', 'diesel_flow':'flow', 'diesel_head':'head', 'diesel_speed':'speed_rpm'
            };
            ...
            var electricalSelection = {
                'electrical_pumpmodels':'wilo_pump_models', 'electrical_pumptype':'pump_type', 'electrical_frequency':'frequency', 'electrical_pump_approval':'pump_approval', 'electrical_flow':'flow', 'electrical_head':'head', 'electrical_speed':'speed_rpm'
            };
            ...
            if (other_pump_modal != '') {
                ...
                electrical_data.push({name: 'electrical_pumpmodels', value: other_pump_modal});
            }
            ...
            if (other_pump_modal != '') {
                ...
                diesel_data.push({name: 'diesel_pumpmodels', value: other_pump_modal});
            }
    ...
    function dieselPumpPriceCalculate() {
        ...
        if (checkvalblank) {
            ...
            if (other_pump_modal != '') {
                ...
                dieselserialize.push({name: 'id', value: other_pump_modal_id});
                dieselserialize.push({name: 'diesel_pumpmodels', value: other_pump_modal});
            }
            if (dieselSelectionData.length > 0) {
    ...
    function electricalPumpPriceCalculate() {
        ...
        if (checkvalblank) {
            ...
            if (other_pump_modal != '') {
                ...
                electricalserialize.push({name: 'id', value: other_pump_modal_id});
                electricalserialize.push({name: 'electrical_pumpmodels', value: other_pump_modal});
            }
            if (electricalSelectionData.length > 0) {
    ...
    function jockeyPumpPriceCalculate() {
        ...
        if (checkvalblank) {
            ...
            var jockeypump_article_data = jQuery.grep(jockeypump, function (articless) { return articless.pump_article_no == jockeypump_article_no });
...
<script>
    ...
    $(document).on('click', '.select-other-pump-modal', function () {
        ...
        $('#other-pump-success-modal').find('.modal-body').find('h4').text('').text(`${other_pump_modal} Pump Modal select Successful!`);
    ...
    $(document).on('blur', 'input[name="jockey_article_number"]', function () {
        ...
        if (jockeypump_article_no != '') {
            ...
            if ($.isArray(jockeypump_article_data) && jockeypump_article_data.length > 0) {
                ...
                $('#jockey_frequency').find('option').remove().end().append('<option>'+jockeypump_article_data[0]['frequency']+'</option>').val(jockeypump_article_data[0]['frequency']).change();
            } else {
                alert('Jockey Pump data not found..!!');
            }
        }
        ...
        switch(pump_type) {
            ...
            case 'electrical':
                    ...
                    if (other_pump_modal != '') {
                        ...
                        cart_pump_data.push({name: 'electrical_pumpmodels', value: other_pump_modal});
                    }
                break;
            ...
            case 'diesel':
                    ...
                    if (other_pump_modal != '') {
                        cart_pump_data.push({name: 'id', value: other_pump_modal_id});
                        cart_pump_data.push({name: 'diesel_pumpmodels', value: other_pump_modal});
                    }
                break;
            ...
            case 'electrical-diesel':
                    ...
                    if (other_pump_modal != '') {
                        ...
                        cart_pump_extra_data.push({name: 'diesel_pumpmodels', value: other_pump_modal});
                    }
                break;
        }
        $.ajax({
