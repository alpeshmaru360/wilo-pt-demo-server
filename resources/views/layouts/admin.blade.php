...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="left: inherit; right: 0px;">
          ...
          <a href="{{ route('admin.profile') }}" class="btn btn-default btn-flat">{{ trans('global.profile') }}</a>
            <a href="#" onclick="event.preventDefault(); document.getElementById('logoutform').submit();" class="btn btn-default btn-flat float-right">{{ trans('global.logout') }}</a>
          </li>
        </ul>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{URL::to('/')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Wilo</span>
    </a>
