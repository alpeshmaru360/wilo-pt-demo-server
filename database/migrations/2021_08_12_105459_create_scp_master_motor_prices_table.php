...
class CreateScpMasterMotorPricesTable extends Migration {
     ...
     */
    public function up() {
        Schema::create('scp_master_motor_prices', function (Blueprint $table) {
            $table->id();
            $table->string('brand');
            $table->float('power');
            $table->string('motor_article_number', 8, 2);
            $table->string('wilo_article_number', 8, 2);
    ...
    public function down() {
        Schema::dropIfExists('scp_master_motor_prices');
    }
